...
6. In phpmyadmin page, create a new database from the left panel and name it as 'admindb'
7. Import the file 'admindb.sql' inside your newly created database and click ok.
...
Hospital Management System in php and mysql. This system has a ‘Home’ page from where the Teacher, professor & administrator can login into their accounts by toggling the tabs accordingly. Fig 1.1 shows the ‘Home’ page of our project.
...
Once the Teacher has created his/her own account after clicking the ‘Register’ button, then he will be redirected to his/her Dashboard(Fig 1.5).

![image](https://user-images.githubusercontent.com/36665975/66570123-8c196700-eb8a-11e9-845f-ea02013f1d5c.png)

The Dashboard page allows Teachers to perform two operations:

**1. Book his/her appointment:**

  &nbsp; &nbsp; &nbsp; Here, the Teachers can able to book their appointments to see a professor. The appointment form(Fig 1.6) requires Teachers to select the professor that they want to see, Date and Time that they want to meet with the professor. The consultancy fee will be shown accordingly to the Teacher as it was already determined by the professor.

![image](https://user-images.githubusercontent.com/36665975/66570202-c256e680-eb8a-11e9-8839-6c7fef68ac4c.png)

After clicking on the ‘Create new entry’ button, the Teacher will receive an alert that acknowledges the successful appointment of the Teacher.(See Fig 1.7) 

![image](https://user-images.githubusercontent.com/36665975/66570280-ec100d80-eb8a-11e9-96c2-08e5441954d0.png)

**2. View Teachers’ Appointment History:**

  &nbsp; &nbsp; &nbsp; Here, the Teacher can see their appointment history which contains professor Name, Consultancy Fee, Appointment Date and Time.(See Fig 1.8).
	
![image](https://user-images.githubusercontent.com/36665975/66570349-0ea22680-eb8b-11e9-94fe-22a86070a274.png)

Once the Teacher has logged out of his account, if he wants to go into his account again, he can login his account, instead of register his account again. Fig 1.9 shows the login page.
Clicking on ‘Login’ button will redirect the Teacher to his dashboard page which we have seen earlier (Fig 1.5)

![image](https://user-images.githubusercontent.com/36665975/66570502-588b0c80-eb8b-11e9-88e3-5294ae896ace.png)

This is how the Teacher module works. On the whole, this module allows Teachers to register their account or login their account(if he/she has one), book an appointment and view his/her appointment history.

### professor Module:

  &nbsp; &nbsp; &nbsp; The professors can login into their account which can be done by toggling the tab from ‘Teacher’ to ‘professor’. Fig 1.10 shows the login form for a professor. Registration of a professor account can be done only by admin. We will discuss more about this in Admin Module.
  
![image](https://user-images.githubusercontent.com/36665975/66570609-8bcd9b80-eb8b-11e9-8099-9f285aa7fe0f.png)

Once the professor clicking the ‘Login’ button, they will be redirected to their own dashboard which is shown in Fig 1.11

![image](https://user-images.githubusercontent.com/36665975/66570642-a0119880-eb8b-11e9-8d23-be898e1bfa29.png)

In this page, professor can able to see their appointments which has been booked by the Teachers. Fig 1.12 shows the appointment of the professor ‘Ganesh’ which has been booked by the Teacher ‘Kenny Sebastian’ (Fig 1.6). This means that the professor ‘Ganesh’ will have an appointment with the Teacher ‘Kenny Sebastian’ on 10-10-2019 10AM. 
...
**4. Add professor:**
  ...
  After adding a new professor, if we check the professor’s list, we will see the details of new professor is added to the list as shown in the Fig 1.19
...
**5. View User’s feedback/Queries:**
  ...
  &nbsp; &nbsp; &nbsp; Taking everything into consideration, admin can able to view the details of Teachers and professors, appointment details, Feedback by the user and can add a new professor. Once everything is done, the admin can logout from his account.

## Updates

### 1. Cancel Appointments
	
   &nbsp; &nbsp; &nbsp; Teachers and professors can able to delete their appointments.
 
   ![image](https://user-images.githubusercontent.com/36665975/75169587-d0c72880-574e-11ea-9a9e-ba098c04e594.png)
    
  If the Teacher deletes the last record (for professor Ganesh), then a label "deleted by you" will be displayed in the column 'Current Status' and the action will change to cancel state.
  
  ![image](https://user-images.githubusercontent.com/36665975/75169873-47642600-574f-11ea-8ca4-420b0dfd20c3.png)
  
  Now if we login to the professor Ganesh's account and view his appointment details, then it will look like this:
  
  ![image](https://user-images.githubusercontent.com/36665975/75170076-9316cf80-574f-11ea-84ff-6a5976ce8179.png)
  
  Similarly professors can also delete their appointments and Teachers can view their updated appointment details.
  
### 2. Remove professors by Admin

&nbsp; &nbsp; &nbsp; Admin can also delete the professors from the system. This let admin to have more control over the system.
