...
$professor = $_SESSION['dname'];
if(isset($_GET['cancel']))
  {
    $query=mysqli_query($con,"update appointmenttb set professorStatus='0' where ID = '".$_GET['ID']."'");
    if($query)
    {
  ...
  //   $query=mysqli_query($con,"insert into prestb(professor,pid,ID,appdate,apptime,disease,allergy,prescription) values ('$professor',$pid,$ID,'$appdate','$apptime','$disease','$allergy','$prescription');");
  //   if($query)
  //   {
    ...
    <div class="tab-pane fade" id="list-app" role="tabpanel" aria-labelledby="list-home-list">
                  ...
                  <?php 
                    ...
                    while ($row = mysqli_fetch_array($result)){
                      ...
                      <td><?php echo $row['pid'];?></td>
                        ...
                        <td>
                    <?php if(($row['userStatus']==1) && ($row['professorStatus']==1))  
                    {
                      echo "Active";
                    }
                    if(($row['userStatus']==0) && ($row['professorStatus']==1))  
                    {
                      echo "Cancelled by Teacher";
                    }
                    ...
                    if(($row['userStatus']==1) && ($row['professorStatus']==0))  
                    {
                     ...
                     <td>
                        ...
                        { ?>
	                        ...
	                        <a href="professor-panel.php?ID=<?php echo $row['ID']?>&cancel=update" 
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          ...
          <input type="submit" name="docsub" value="Add professor" class="btn btn-primary">
        </form>
      </div>
